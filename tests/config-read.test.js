...
describe('readConfig — overrides', () => {
    ...
    settings.set_string('active-vendor', 'openrouter');
    ...
    settings.set_boolean('openrouter-enabled', true);
    ...
    it('honors the active-vendor override', () => assertEqual(cfg.activeVendor, 'openrouter'));
    ...
    it('honors a vendor enable toggle', () => assertEqual(cfg.vendors.openrouter.enabled, true));

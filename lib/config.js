    ...
    return {
        ...
        vendors: {
            ...
            zai: {
                ...
                refreshIntervalSecs: settings.get_int('zai-refresh-interval'),
            },
            openrouter: {
            ...
            deepseek: {
                ...
                refreshIntervalSecs: settings.get_int('deepseek-refresh-interval'),
            },
            kimi: {
                enabled: b('kimi-enabled'),
                apiKeyEnv: s('kimi-api-key-env'),
                apiKey: emptyToNull(s('kimi-api-key')),
                refreshIntervalSecs: settings.get_int('kimi-refresh-interval'),
            },
            gemini: {

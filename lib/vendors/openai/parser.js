...
export function placeholders(snapshot, now) {
    ...
    m.set('session_pct', fmtPct(session.utilizationPct));
    m.set('session_used_pct', fmtPct(session.utilizationPct));
    m.set('session_left_pct', fmtPct(100 - session.utilizationPct));
    m.set('session_reset', sessionReset);
    m.set('weekly_pct', fmtPct(weekly.utilizationPct));
    m.set('weekly_used_pct', fmtPct(weekly.utilizationPct));
    m.set('weekly_left_pct', fmtPct(100 - weekly.utilizationPct));
    m.set('weekly_reset', weeklyReset);
    m.set('plan', snapshot.plan);

    m.set('oai_plan', snapshot.plan);
    m.set('oai_session_pct', fmtPct(session.utilizationPct));
    ...
    m.set('oai_weekly_pct', fmtPct(weekly.utilizationPct));
    ...
    m.set('oai_code_review_pct', fmtPct(codeReview ? codeReview.utilizationPct : 0));
